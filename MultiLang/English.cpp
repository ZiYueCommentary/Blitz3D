...
static constexpr const char* invalid_macro_name = "Invalid macro name {0} at line {1}";
static constexpr const char* redefinition_of_macro = "Redefinition of macro {0} at line {1}";
static constexpr const char* error_evaluating_condition = "Error evaluating condition: {0} at line {1}";
static constexpr const char* elseif_without_if = "#elseif without matching #if at line {0}";
static constexpr const char* else_without_if_macro = "#else without matching #if at line {0}";
static constexpr const char* error_macro = "\"{0}\" at line {1}";
static constexpr const char* macro_exceeded = "Macro expansion depth exceeded at line {0}";
